         ...
         <ul className="flex items-center hidden space-x-8 lg:flex">
           <li>
             <NavLink
               ...
               aria-label="Home"
               title="Home"
               className={({isActive})=> isActive ? 'font-medium tracking-wide text-green-500 transition-colors duration-200 hover:text-deep-purple-accent-400' : 'font-medium tracking-wide text-white-800 transition-colors duration-200 hover:text-deep-purple-accent-700'}
             >
               Home
             </NavLink>
           </li>
